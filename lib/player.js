...
const SPEED_DIVIDER = [120, 100, 110, 90, 110, 120, 105, 105, 100, 100, 100, 100, 100],
	NOCTAN = new Set([1206, 1210, 1230, 1300, 1301, 1302, 1303, 81212, 201225]),
	...
	constructor(mod) {
		...
		mod.hook('S_PLAYER_STAT_UPDATE', mod.majorPatchVersion >= 93 ? 14 : 13, HOOK_LAST, event => {
			Object.assign(this, {
				...
				attackSpeed: (event.attackSpeed + event.attackSpeedBonus) / SPEED_DIVIDER[this.job],
